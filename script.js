...
muteVolume() {
    ...
    */
    this.isMuted ? (volumeToggler.setAttribute('data-volume', volumeToggler.value), volumeToggler.value = 0) : volumeToggler.value = volumeToggler.getAttribute('data-volume');
}
...
timeUpdate() {
    ...
    if (this.hide && document.fullscreenElement) {
        this.hidePanel();
    }
}
